...
namespace FinalProject.Controllers
{
    public class PermissionsController : Controller
    {
        ...
        public PermissionsController(FinalProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,PermissionName")] Permissions permissions)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PermissionName")] Permissions permissions)
        {
